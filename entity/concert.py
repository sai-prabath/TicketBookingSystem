...
class Concert(Event):
    def __init__(self, event_id=None, event_name=None, event_date=None, event_time=None, venue_id=None, total_seats=0, available_seats=0, ticket_price=0.0, event_type=None, artist=None, concert_type=None):
